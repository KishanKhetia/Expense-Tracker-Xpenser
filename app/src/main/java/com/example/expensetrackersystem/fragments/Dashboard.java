...
import com.example.expensetrackersystem.fragments.cost_sharing;
 ...
 */
public class Dashboard<CostSharingFragment> extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnCostSharing = view.findViewById(R.id.btn_cost_sharing);

        // Set an empty click listener for now
        btnCostSharing.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                cost_sharing costSharingFragment = new cost_sharing();
                getParentFragmentManager().beginTransaction()
                        .replace(R.id.flFragment, costSharingFragment)
                        .addToBackStack(null)
                        .commit();
            }
        });
